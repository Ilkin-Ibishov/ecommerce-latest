  ...
  if (!user && !loading) {
    return (
      <div className="container mx-auto px-4 py-16 max-w-lg text-center">
        ...
        <p className="text-muted-foreground mb-6">Sign in to save products to your wishlist.</p>
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-2xl font-bold mb-6 flex items-center gap-2">
        <Heart size={22} className="text-primary" /> Wishlist
        {items.length > 0 && <span className="text-base font-normal text-muted-foreground">({items.length} items)</span>}
      </h1>
