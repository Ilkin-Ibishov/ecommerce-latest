          ...
          return (
            <Link key={product.id} href={`/${locale}/products/${product.slug}`}
              ...
              <div className="relative aspect-square bg-muted overflow-hidden">
                {img ? (
                  <img src={img} alt={name} className="object-cover w-full h-full group-hover:scale-105 transition duration-300" />
                ) : (
              ...
              <div className="p-3">
                <h3 className="font-medium text-sm line-clamp-2 group-hover:text-primary transition">{name}</h3>
              ...
              return (
                <Link key={cat.id} href={`/${locale}/categories/${cat.slug}`}
                  ...
                  {cat.icon_url ? (
                    ...
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-xl">🛍️</div>
                  )}
            ...
            <div className="flex flex-col md:flex-row gap-6 p-6">
              {dealOfDay.product_images?.[0]?.url && (
                <div className="w-full md:w-64 h-48 md:h-auto rounded-xl overflow-hidden bg-white shrink-0">
                  <img src={dealOfDay.product_images[0].url} alt="" className="object-cover w-full h-full" />
                </div>
              )}
