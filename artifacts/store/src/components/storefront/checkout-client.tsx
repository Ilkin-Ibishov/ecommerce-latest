    ...
    return (
      <div className="container mx-auto px-4 py-16 max-w-lg text-center">
        ...
        <p className="text-muted-foreground mb-2">
          Thank you, {form.customer_name}. Your order has been received.
        </p>
  ...
  if (items.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <a href={`/${locale}/products`} className="text-primary hover:underline text-sm">
          Browse products
        </a>
      </div>
    );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="bg-card border border-border rounded-xl p-5 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Leave a note for the courier…"
                rows={2}
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            {coupon && (
              <p className="text-green-600 text-xs mt-1 font-medium">
                ✓ -{coupon.discount_amount.toFixed(2)} AZN discount applied
          ...
          <p className="text-xs text-center text-muted-foreground">
            Cash on delivery · Pay in AZN when your order arrives
          </p>
        </form>
