    ...
    <div>
      ...
      {comments.length === 0 ? (
        ...
        <div className="space-y-3">
          {comments.map((c) => {
            const productTitle =
              (c.products?.product_translations as any[])?.find((t: any) => t.lang_code === "az")?.title ??
              c.products?.slug ?? "Unknown product";
            return (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {!c.approved ? (
                    <button
                      ...
                      className="p-1.5 rounded hover:bg-green-500/20 text-muted-foreground hover:text-green-400 transition"
                      title="Approve"
                    >
                      <CheckCircle size={16} />
                    </button>
                    ...
                    <button
                      ...
                      className="p-1.5 rounded hover:bg-yellow-500/20 text-muted-foreground hover:text-yellow-400 transition"
                      title="Unapprove"
                    >
                      <XCircle size={16} />
                    </button>
