...
def cmd_selftest(args):
    class LTMSelfTest(unittest.TestCase):
        ...
        def test_05_purge_last_dry_run(self):
            ...
            CUR_SESSION.write_text(json.dumps({"session_id": "s1", "started_at": "2026-01-01T00:00:00Z", "last_event_at": "2026-01-01T00:00:00Z", "event_count": 1}))
